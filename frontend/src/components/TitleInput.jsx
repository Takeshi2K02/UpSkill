  ...
  return (
    <div className="mb-4">
      ...
      <input
        ...
        className="w-full border border-gray-300 rounded-lg px-4 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm shadow-sm"
        placeholder="Enter a plan title or select from suggestions..."
      />
        {value && (
          <button
