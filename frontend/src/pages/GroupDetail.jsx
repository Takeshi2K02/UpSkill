...
export default function GroupDetail() {
  ...
  if (errorGroup) {
    return <p className="p-6 text-red-600">{errorGroup}</p>;
  }
          ...
          return (
            <div key={post.id} className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="px-4 py-2 border-t border-gray-100 flex justify-around">
                ...
                />
                <button
                  className="flex items-center space-x-1 p-2 text-gray-500 hover:text-blue-500 rounded-lg focus:outline-none"
                >
